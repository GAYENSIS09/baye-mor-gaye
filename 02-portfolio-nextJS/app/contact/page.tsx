  ...
  if (sent) {
    return (
      <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center">
        <div className="w-full bg-[#111] p-4 sm:p-8 rounded border border-[#222] text-center">
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      <main className="max-w-lg mx-auto p-4 py-8">
        <form onSubmit={handleSubmit} className="w-full bg-[#111] p-4 sm:p-6 rounded border border-[#222] space-y-4">
